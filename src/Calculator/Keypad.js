    ...
    return (
        <div className="keypad">
            <div className="keypad-row">
                ...
                <button className="btn keypad-secondary-btn" value="backspace" onClick={props.onDelete}>Del</button>
            ...
            <div className="keypad-row">
                ...
                <button className="btn keypad-secondary-btn" value="=" onClick={props.onEquals}>=</button>
            </div>
        </div>
    );
};
